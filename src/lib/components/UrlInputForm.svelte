<script lang="ts">
  ...
  import { SongsterrService } from '$lib/services/songsterr.service';
  import { getActiveSongsterrTabUrl } from '$lib/utils/active-tab.util';
  ...
  onMount(() => {
    getActiveSongsterrTabUrl().then((activeUrl) => {
